...
//! Internal architecture-intrinsic catalog.
//!
//! This module intentionally re-exports a broader, target-feature-grouped set
//! of intrinsics than the current implementation calls. Keeping the catalog in
//! the repository makes new backend work and instruction comparison practical
//! without repeatedly reconstructing long import lists. Unused imports are
//! therefore expected, and the lint allowance is scoped to this file.
//!
//! Every export remains `pub(crate)` and does not extend the crate's public API.
//! Availability in this catalog is not a safety or portability guarantee: each
//! call site remains responsible for the correct architecture and target-feature
//! gating, argument invariants, and `unsafe` justification.
//!
//! Do not prune this catalog merely because an import is currently unused. Revisit
//! its organization or generation only when measured compile-time, maintenance,
//! or package-size costs outweigh its value during backend implementation.
...
// AVX-512 intrinsics stable in Rust 1.97, grouped by their minimal target-feature requirements.
// Generated from the official rust-src attributes, then reduced using rustc's feature implications.
#[cfg(target_feature = "avx512bf16")]
pub(crate) mod avx512_bf16 {
    pub(crate) use core::arch::x86_64::{
        _mm512_cvtne2ps_pbh,
        _mm512_cvtneps_pbh,
        _mm512_cvtpbh_ps,
...
#[cfg(all(target_feature = "avx512bitalg", target_feature = "avx512vl"))]
pub(crate) mod avx512_bitalg_vl {
    pub(crate) use core::arch::x86_64::{
...
#[cfg(all(target_feature = "avx512dq", target_feature = "avx512vl"))]
pub(crate) mod avx512_dq_vl {
    pub(crate) use core::arch::x86_64::{
        _mm_broadcast_i32x2,
        _mm_cvtepi64_pd,
        _mm_cvtepi64_ps,
...
#[cfg(all(target_feature = "avx512fp16", target_feature = "avx512vl"))]
pub(crate) mod avx512_fp16_vl {
    pub(crate) use core::arch::x86_64::{
        _mm_abs_ph,
        _mm_add_ph,
        _mm_cmp_ph_mask,
...
pub(crate) mod avx512_vpopcntdq {
    pub(crate) use core::arch::x86_64::{
...
#[cfg(all(target_feature = "avx512vpopcntdq", target_feature = "avx512vl"))]
pub(crate) mod avx512_vpopcntdq_vl {
    pub(crate) use core::arch::x86_64::{
...
#[cfg(all(target_feature = "avx512bw", target_feature = "gfni"))]
pub(crate) mod avx512_bw_gfni {
    pub(crate) use core::arch::x86_64::{
...
#[cfg(all(target_feature = "avx512bw", target_feature = "avx512vl", target_feature = "gfni"))]
pub(crate) mod avx512_bw_vl_gfni {
    pub(crate) use core::arch::x86_64::{
...
pub(crate) mod avx512_f_vpclmulqdq {
    pub(crate) use core::arch::x86_64::_mm512_clmulepi64_epi128;
}
